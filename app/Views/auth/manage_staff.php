                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-light text-dark border">
                                <?= (!empty($staff['duty_day'])) ? esc($staff['duty_day']) : 'Not Set' ?>
                            </span>
                        </td>
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?= base_url('auth/delete/'.$staff['id']) ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Sigurado ka nga gusto mo i-delete ini?')"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; else: ?>
                        <tr><td colspan="4" class="text-center py-4 text-muted">No staff members found.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
